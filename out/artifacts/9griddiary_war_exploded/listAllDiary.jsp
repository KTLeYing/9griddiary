...
%>
<jsp:useBean id="pagination" class="com.utils.MyPagination"
	scope="session" />
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<script type="text/javascript" src="${pageContext.request.contextPath}/js/excanvas-modified.js"></script>
			...
			return false;
				...
				<div
					...
					<div id="diaryImg${id.count }"
						style="border: 1px #DDDDDD solid; width: 60px; background-color: #EEEEEE;display:inline-table;">
