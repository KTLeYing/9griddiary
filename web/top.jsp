...
function Myopen(divID){ 								//根据传递的参数确定显示的层
	 ...
	 notClickDiv.style.display='block';						//设置层显示
      ...
      document.getElementById(divID).style.left=(document.body.clientWidth-240)/2+"px";		//设置由divID所指定的层的左边距
      document.getElementById(divID).style.top=(document.body.clientHeight-139)/2+"px";		//设置由divID所指定的层的顶边框
}
...
#navigation{			/*设置导航条的样式 background-image:url(/images/navigation_bg.jpg);*/
