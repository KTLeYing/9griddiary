...
<!-- 使用JQuery解决PNG图片背景不透明的问题 -->
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/pluginpage.js"></script>
...
padding-top:70px;						/*设置顶边距*/
padding-left:63px;						/*设置左边距*/
}
</style>
...
function setTemplate(style){
	if(style=="默认"){
		...
		document.getElementById("writeDiary_bg").style.width="938px";	//宽度
		document.getElementById("writeDiary_bg").style.height="891px";	//高度
		document.getElementById("writeDiary_bg").style.paddingTop="70px";//顶边距
		document.getElementById("writeDiary_bg").style.paddingLeft="63px";//左边距
		...
		document.getElementById("writeDiary_bg").style.width="950px";	//宽度
		document.getElementById("writeDiary_bg").style.height="713px";	//高度
		document.getElementById("writeDiary_bg").style.paddingTop="220px";//顶边距
		document.getElementById("writeDiary_bg").style.paddingLeft="70px";//左边距
		...
		document.getElementById("writeDiary_bg").style.width="940px";	//宽度
		document.getElementById("writeDiary_bg").style.height="928px";	//高度
		document.getElementById("writeDiary_bg").style.paddingTop="50px";//顶边距
		document.getElementById("writeDiary_bg").style.paddingLeft="80px";	//左边距
		document.getElementById("template").value="怀旧";
	}
}
window.onload=function(){

	setTemplate(form1.template.value);
